...
public class FactorizerWithCache_bug implements FactorizerService {

	private CacheWithBug cache;

	FactorizerWithCache_bug(int cacheSize) {
		cache = new CacheWithBug(cacheSize);
	}
