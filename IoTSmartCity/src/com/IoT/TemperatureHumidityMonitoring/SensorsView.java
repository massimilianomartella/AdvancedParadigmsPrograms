...
public class SensorsView extends JFrame implements ActionListener {
	...
	private JTextField maxValueTemperature, minValueTemperature, maxValueHumidity, minValueHumidity;
	private JTextField temperatureRange, humidityRange, frequencyTemperature, frequencyHumidity;
	...
	public SensorsView() {
		...
		scrollTemperature.setVerticalScrollBarPolicy(JScrollPane.VERTICAL_SCROLLBAR_ALWAYS);
		...
		scrollHumidity.setVerticalScrollBarPolicy(JScrollPane.VERTICAL_SCROLLBAR_ALWAYS);
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (cmd.equals("start")) {
			...
			notifyStarted(Double.parseDouble(temperatureRange.getText()),
					Integer.parseInt(frequencyTemperature.getText()), Double.parseDouble(humidityRange.getText()),
	...
	private void notifyStarted(double temperatureRange, int frequencyTemperature, double humidityRange,
			int frequencyHumidity) {
		for (InputListener l : listeners) {
			l.started(temperatureRange, frequencyTemperature, humidityRange, frequencyHumidity);
		}
	}
